...
def complete_intro(model_path, embedded_corpus_path, title, abstract, partial_intro):
    ...
    input_text = f"Introduction: {partial_intro}"
...
def test():
    ...
    partial_intro = "<|paper_start|>Long document understanding has garnered increasing attention in the field of natural language processing (NLP) due to its wide range of applications across various domains, including legal document analysis, scientific literature categorization, and clinical text mining."
