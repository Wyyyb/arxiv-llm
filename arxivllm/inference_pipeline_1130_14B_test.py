...
def test():
    ...
    partial_intro = "Large foundation models"
    ...
    embedded_corpus_path = "../embedded_corpus/1130_14B_shards/"
    ...
    with open("../local_1130/test_results_1130/mega-bench-14B-ckpt-1000_v1_title_only.txt", "w") as fo:
        fo.write(result)
