...
def transfer_single(file_dir):
    step_7_info_path = os.path.join(file_dir, "step_7_1128_14B_10k_info_use_multi.json")
    ...
    for step_7_info in step_7_info_list:
        ...
        # time.sleep(10)
    step_8_info_path = os.path.join(file_dir, "step_8_info_1128_14B_10k.json")
...
def check_train_data_token_num(tokenizer, train_data):
    ...
    while i < len(train_data):
        ...
        for k in range(len(token_num_list)):
            if token_num_list[k] > 10001:
                print("exceed 10001 length\n", "count:", exceed_count)
                exceed_count += 1
                continue
...
def run_on_darth_server(input_dir):
    ...
    train_data_path = "../local_1128_14B_10k/train_data_1128_14B_10k.jsonl"
    ...
    with open(train_data_path, "w") as fo:
        for each in train_data:
            ...
            fo.write("\n")
    eval_data_path = "../local_1128_14B_10k/eval_data_1128_14B_10k.jsonl"
