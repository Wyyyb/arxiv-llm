...
def transfer_single(file_dir):
    step_7_info_path = os.path.join(file_dir, "step_7_1127_info_use_multi.json")
    ...
    for step_7_info in step_7_info_list:
        ...
        # time.sleep(10)
    step_8_info_path = os.path.join(file_dir, "step_8_info_1126_use_multi.json")
...
def run_on_darth_server(input_dir):
    ...
    train_data_path = "../local_1127/train_data_1127_use_multi.jsonl"
    ...
    with open(train_data_path, "w") as fo:
        for each in train_data:
            ...
            fo.write("\n")
    eval_data_path = "../local_1127/eval_data_1127_use_multi.jsonl"
