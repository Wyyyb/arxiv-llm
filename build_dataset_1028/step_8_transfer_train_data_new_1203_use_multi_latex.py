...
def transfer_single(file_dir):
    step_7_info_path = os.path.join(file_dir, "step_7_1203_info_use_multi_latex.json")
    ...
    for step_7_info in step_7_info_list:
        ...
        # time.sleep(10)
    step_8_info_path = os.path.join(file_dir, "step_8_info_1203_use_multi_latex.json")
...
def run_on_darth_server(input_dir):
    ...
    os.makedirs("../local_1203", exist_ok=True)
    random.shuffle(train_data)
    eval_data = train_data[0: 5000]
    train_data = train_data[5000:]
    train_data_path = "../local_1203/train_data_1203_use_multi.jsonl"
    ...
    with open(train_data_path, "w") as fo:
        for each in train_data:
            ...
            fo.write("\n")
    eval_data_path = "../local_1203/eval_data_1203_use_multi.jsonl"
